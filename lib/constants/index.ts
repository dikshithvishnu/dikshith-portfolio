...
technical excellence with practical business impact.`,
  ...
  workExperience: [
    {
      ...
      description: "As a Software Development Engineer at Trendline Labs, I am responsible for developing and maintaining the company's web applications and APIs.",
      skills: ["ReactJS", "NextJS", "Tailwind CSS", "Python", "Flask", "Postgres", "GCP", "Git", "Docker", "GitHub Actions", "Webhooks"],
    },
    {
  ...
  projects: [
    ...
    // },
    {
      title: "Trendline Sports API",
      description: `Utilized FastAPI, LangChain and LangGraph to build a natural language to SQL search feature for sports enthusiasts. Deployed using Docker and NGINX on GCP Compute Engine with CI/CD workflows`,
      url: `https://api.trendlinelabs.ai`,
      image: "/trendline.png",
    },
    {
      ...
      url: `https://www.researchgate.net/publication/392079867_Chat_with_the_%27For_You%27_Algorithm_An_LLM-Enhanced_Chatbot_for_Controlling_Video_Recommendation_Flow`,
      image: "/cu.png",
    },
    // {
    //   title: "The Meme Club",
